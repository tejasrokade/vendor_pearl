...
DEBUG = False
default_manifest = ".repo/manifests/pearl_default.xml"
...
org_manifest = "PEARL-Devices"  # leave empty if org is provided in manifest
org_display = "PEARL-Devices"  # needed for displaying
